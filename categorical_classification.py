...
if __name__ == "__main__":
    ...
    if os.path.exists('train_data_{}x{}.npy'.format(img_size, img_size)) is False:
        print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
        ...
        """
        Remember if using rgb change the input at config_model_architecture
        """
    ...
    test_data_gen = validation_image_generator.flow(test_X, test_Y, batch_size=64, shuffle=False)
                    ...
                    for regularizator in l2_score:
                        for batch in batch_size:
                            for epoch in epochs:
                                ...
                                print(metrics.head())
                                metrics.to_csv("images/documentation/good/metrics.csv", index=False)
